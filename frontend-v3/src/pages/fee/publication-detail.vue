...
<template>
  <div class="page">
    ...
    <StateView
      ...
      :empty="!pub"
      empty-title="公示不存在"
      empty-description="该公示可能已被撤回，或链接已失效"
      @retry="load"
    >
    <template v-if="pub">
      <div class="card">
...
.sum-item .val.green { color: var(--color-success); }
