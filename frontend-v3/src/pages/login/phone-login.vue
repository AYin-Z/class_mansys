 ...
 *  - 错误文案具体化：手机号不存在 / 密码错误 / 网络连接失败，英文原文不外露。
...
const canLogin = computed(() => phone.value.trim().length >= 11 && password.value.length > 0)
...
<template>
  <div class="login-page">
    <div class="login-header">
      <div class="logo"><AppIcon name="phone" :size="30" /></div>
      <h1>手机号登录</h1>
      <p>使用绑定手机号和密码登录</p>
    </div>
