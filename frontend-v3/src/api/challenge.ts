...
export function judgeApplication(applicationId: number, result: 'challenger_win' | 'champion_win' | 'reject', notes?: string): Promise<{ success: boolean; message: string }> {
  return put(`/api/challenge/application/${applicationId}/judge`, { result, notes })
}
