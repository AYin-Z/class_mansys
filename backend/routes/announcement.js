...
router.post('/create', authenticateToken, AnnouncementController.createAnnouncement);
router.get('/resources', authenticateToken, AnnouncementController.listResources);
router.post('/resources/upload', authenticateToken, uploadResource.single('file'), AnnouncementController.uploadResource);
