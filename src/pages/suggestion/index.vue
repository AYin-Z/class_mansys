...
.tab-item.active { background: #001e40; }
...
.status-bar {
  ...
  &.processing { background: #003366; }
  &.replied { background: #001e40; }
}
...
.sug-cat { font-size: 22rpx; color: #466270; letter-spacing: 2rpx; text-transform: uppercase; font-weight: 600; }
.sug-title { font-size: 27rpx; font-weight: 500; color: #191c1e; line-height: 1.5; display: block; margin-bottom: 10rpx; }
.sug-time { font-size: 22rpx; color: #c3c6d1; }
.status-tag {
