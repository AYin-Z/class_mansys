<template>
  <view class="approve-page">
    <custom-nav-bar title="经费审批" :showBack="true" />
    <scroll-view scroll-y class="main-scroll">
      ...
      <view class="app-list">
        <view v-for="item in displayList" :key="item.id" class="app-card">
          <view class="card-accent" :class="item.amount >= 500 ? 'large' : 'small'"></view>
          <view class="card-body">
            ...
            <view class="action-area" v-if="currentTab === 'pending' && !item.processed">
              ...
              <button class="action-btn approve" @click="approve(item)">通过审批</button>
            </view>
...
const pendingList = ref([
  { id: 1, purpose: '购买班级活动物资', amount: '320.00', details: '横幅×2、气球×100、装饰品若干', applicant: '张三', time: '2026-04-09', processed: false },
  { id: 2, purpose: '校外实践交通费', amount: '680.00', details: '大巴租赁费用', applicant: '李四', time: '2026-04-08', processed: false }
])

const doneList = ref([
  { id: 3, purpose: '打印学习资料', amount: '45.00', details: '复习资料打印30份', applicant: '王五', time: '2026-04-07', processed: true, approved: true },
  { id: 4, purpose: '购买清洁用品', amount: '186.50', details: '拖把×3、扫把×5', applicant: '赵六', time: '2026-04-05', processed: true, approved: false }
])
